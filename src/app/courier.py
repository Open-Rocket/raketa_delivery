...
async def courier_accept_tou(
    ...
    if is_set_reg and is_set_courier_to_db:
        ...
        new_courier_info = (
            ...
            "🚀 Наш сервис связывает вас с клиентами напрямую — без посредников и комиссий.\n\n"
            "<b>Что нужно знать:</b>\n"
            "• Оплата — сразу вам, без процентов.\n"
            "• Подписка нужна для доступа к заказам — недорогая и быстро окупается (2–3 доставки).\n"
            "• Telegram-бот — ваш рабочий инструмент. Ведём разработку полноценного приложения.\n"
            "• Мы растём и делаем сервис лучше каждую неделю.\n\n"
            "<b>Доступные доставки:</b>\n"
            "• p2p — личные поручения (ключи, покупки, документы).\n"
            "• b2c — доставка от магазинов и сервисов.\n\n"
            "⚡️ <b>Важно:</b> только легальные заказы. Никаких странных или запрещённых товаров.\n\n"
            "Вы сами выбираете, когда и сколько работать 💪\n\n"
            "<i>💵 Оплату можно принимать наличными или переводом.</i>\n"
            "Спасибо, что с нами!"
        )
