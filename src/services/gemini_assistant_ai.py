...
class AssistantGemini:
    ...
    async def process_order(
        ...
        moderation = """
            🚫 Не пропускай ничего, кроме **реальных заказов на доставку пешим курьером или taxi.
            Если текст:
        ...
        request = (
            ...
            f'{{"city": "{only_city}", "addresses": "{parsed_address}", "delivery_object": "{delivery_object}", "description": "{description}"}}, "is_taxi": {is_taxi}\n\n'
