...
async def get_image_title_user(command: str):
    ...
    image_paths = {
        ...
        "/profile": os.path.join(title_images_user, "user_profile.jpg"),
        "/faq": os.path.join(title_images_user, "user_faq.jpg"),
        "/ai": os.path.join(title_images_user, "user_ai.jpg"),
        "on_way": os.path.join(title_images_user, "user_on_the_way.jpg"),
